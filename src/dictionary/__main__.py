...
# from src.dictionary.commands.sentences import app as sentences_app
# from src.dictionary.commands.words import app as words_app
...
app.add_typer(
    dictionary_app,
    name="dictionary",
    help="📚 Dictionary commands: list, add to manage vocabulary."
)
